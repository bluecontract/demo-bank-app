 ...
 * The helper internally polls MyOS, forwards only DOCUMENT_CREATED / DOCUMENT_EPOCH_ADVANCED,
 * posts the full webhook payload to bank, and waits for a short quiet period plus optional
 * bank-side settled assertion.
 */
