...
| FR-VCH-BANK-8  | Correlation: Bank persists many-to-many relations so (a) transaction view shows related contracts, and (b) contract view shows related transactions and holds.                                                                                                                                                                                                                                                  | Must     |
