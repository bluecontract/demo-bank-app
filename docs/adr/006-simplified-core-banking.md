...
| 6   | **GSI Attribute Names** – Use explicit attribute names: `BANKING_GSI1PK`, `BANKING_GSI1SK`, `BANKING_GSI2PK`, `BANKING_GSI2SK` for all indexes. Account number lookups use direct item access pattern. | Ensures schema and code are always in sync.                                 |
