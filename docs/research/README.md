...
- `docs/research/blue-document-data-shaping-for-llm-summaries.md` – recommended “extract → narrate” data shaping for predictable summaries.
- `docs/research/behavior-aware-blue-contract-summaries.md` – v2 direction: include operations/workflows + recent events + selective schema packs to explain contract behavior.
- `docs/research/paynote-and-paynote-delivery-state-notes.md` – what “current state” means for the two supported contract types.
